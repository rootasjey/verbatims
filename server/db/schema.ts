...
export const apiKeys = sqliteTable('api_keys', {
  ...
  readRateLimit: integer('read_rate_limit').notNull().default(1000),
  readWindowSec: integer('read_window_sec').notNull().default(3600),
  writeRateLimit: integer('write_rate_limit').notNull().default(1000),
  writeWindowSec: integer('write_window_sec').notNull().default(3600),
  isActive: integer('is_active', { mode: 'boolean' }).default(true),
