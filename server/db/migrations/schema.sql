...
-- Consolidated through: 2026-07-14 (inclusive)
...
-- Social queue for automated publishing
...
-- Social posting history and audit trail
...
-- Entity verification state tracks the verification status of authors and references
...
-- Entity enrichment field proposals for review workflow
...
-- Entity field change history for audit trail
...
CREATE TABLE IF NOT EXISTS api_keys (
  ...
  read_window_sec INTEGER NOT NULL DEFAULT 3600,
  write_rate_limit INTEGER NOT NULL DEFAULT 1000,
  write_window_sec INTEGER NOT NULL DEFAULT 3600,
...
-- API key usage logs for analytics and billing
...
-- Activity logs for admin dashboard feed
