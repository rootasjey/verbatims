        ...
        <div class="hidden md:flex items-center gap-3">
          ...
          >
            <template #trigger="{ modelValue }">
              <span class="text-xs font-medium leading-none py-1">{{ modelValue?.label }}</span>
            </template>
          </NCombobox>
          <NCombobox
              ...
              <td class="px-3 py-3 max-w-md">
                ...
                <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                  <template v-if="quote.author_name">
                    <ContextMenu v-if="quote.author_id" size="xs" native-on-modifier="ctrl" :items="getAuthorActions(quote)">
                  ...
                  <template v-if="quote.reference_name">
                    <ContextMenu v-if="quote.reference_id" size="xs" native-on-modifier="ctrl" :items="getReferenceActions(quote)">
