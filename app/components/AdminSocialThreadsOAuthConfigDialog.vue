<template>
  ...
  >
    ...
    <div class="space-y-6">
      ...
      >
        <template #trailing>
          <NBadge size="xs" badge="soft-gray" rounded="1" class="py-0.5 text-sm">Threads App ID</NBadge>
        </template>
      </NInput>
      ...
      <NInput
        ...
        placeholder="https://your-domain.com/api/admin/social/threads/callback"
        class="bg-white dark:bg-gray-900 b-none shadow-none"
        :una="{ inputTrailingWrapper: 'pr-1.5' }"
      >
        <template #trailing>
